...
public class SimpleDBLoader {
    ...
    ***********************************************************************/
    ...
    public void printHelp()
    {
        ...
        System.out.println("  -minrps/-n : To avoid throttling, we need to slowly ramp up our request speed.");
        System.out.println("               This is the number of requests per-domain, per-second to start with (defaults to 1.0)");
        ...
        System.out.println("  -idname/-e : For CSV loading, the name of the column to use as the item's unique name ");
        System.out.println("               (defaults to 'id', or the first column if none matching the name is found)");
        System.out.println("");
